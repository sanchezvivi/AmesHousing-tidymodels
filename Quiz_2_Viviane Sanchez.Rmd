...
## 1. Introdução
Será feita a modelagem da base [AmesHousing](https://github.com/topepo/AmesHousing) com o pacote tidymodels e alguns dos pacotes apresentados em aula ao longo do curso Programa Avançado em Data Science do Insper (São Paulo, Brasil).
...
Pela base de treino, observa-se que o melhor modelo foi **random forest**, seguido por bagging.
Para confirmar, vamos observar o comportamento na base teste:
...
### 6. Conclusão
Conforme avaliado na análise exploratória, as principais variáveis preditoras foram as mais correlacionadas. Isso explica também o alto desempenho do modelo linear. O pacote tidymodels otimiza o processo de execução e comparação dos modelos, mesmo não possuindo todos os utilizados nesse relatório.
